...
<tr>
<td className='p-2 align-top'><span className='bg-sky-200 rounded-md px-3 py-1 text-sky-700 block font-semibold text-center text-sm'>cur </span></td>
<td className='p-2 align-top'>Supports current value</td>
</tr>
</tbody>
</table>
